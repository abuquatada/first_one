        ...
        try:
            ...
            if serializer.is_valid():
                ...
                if address:
                    ...
                    #     'country': address.country_id.countryName,
        ...
        try:
            ...
            if serializer.is_valid():
                try:
                    ...
                    user = CoreUser.objects.create(username=validated_data["username"],
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                if user:
                    ...
                    return Response({"message":f"Your password reset link : {reset_link}"},
                                    status=status.HTTP_200_OK
                                    )
                else:
    ...
    def post(self, request):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                if serializer.data.get('new_password') != serializer.data.get('Againnew_password'):
